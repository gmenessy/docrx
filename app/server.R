...
shinyServer(function(input, output) {
    ...
    output$Plotfeed <- renderPlotly({
        ...
        y=c(119, 132, 120, 111, 94, 61, 45, 57, 170, 236, 306, 239, 176, 135, 191, 276, 437, 419, 434, 316, 384, 467, 433, 422, 439, 413, 422, 483, 595, 505)
    ...
    output$Plottop <- renderPlotly({
        ...
        x=c("Kontaktverbot-Privat Bereich", "Kontaktverbot", "Aus- und Einreise", "Geschäftsschließung", "Kontaktpersonen", "Veranstaltungsverbot", "Regeln Privat-PKW/Taxi", "Fallzahlen", "Schulöffnung", "Private Bildungseinrichtung")
        y=c(23, 18, 9, 7, 5, 4, 4, 3, 3, 3)
