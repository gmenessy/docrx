...
shinyServer(function(input, output) {
    ...
    output$Plotfeed <- renderPlotly({
        ...
        y=c(119, 132, 120, 111, 94, 61, 45, 57, 170, 236, 306, 239, 176, 135, 191, 276, 437, 419, 434, 316, 384, 467, 433, 422, 439, 413, 422, 483, 595, 505, 745, 722, 469, 364, 343, 449, 348, 328, 357, 341, 256, 344, 440)
