...
shinyServer(function(input, output) {
    ...
    output$Plotdash <- renderPlotly({
        ...
        datadash <- data.frame(trace_c_Datum, trace_c_Anzahl, trace_cim_Anzahl, trace_cem_Anzahl, trace_cra_Anzahl, trace_cca_Anzahl)
    ...
    output$Plotfeed <- renderPlotly({
        ...
        x=c("06.04.2020", "07.04.2020", "08.04.2020", "09.04.2020", "10.04.2020", "11.04.2020", "12.04.2020", "13.04.2020", "14.04.2020")
        y=c(119, 132, 120, 111, 94, 61, 45, 57, 170)
